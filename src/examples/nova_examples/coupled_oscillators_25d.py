...
def define_ha():
    ...
    mode1 = ha.new_mode('1')
    mode1.set_dynamics(
        ["0.1*x4-3*x0+2.0*(x3+x8+x13+x18+x23)", "10*x0-2.2*x1", "10*x1-1.5*x2", "2*x0-20*x3",
         "-5*x4**2*x2**4*(10*x1-1.5*x2)",
         "0.1*x9-3*x5+2.0*(x3+x8+x13+x18+x23)", "10*x5-2.2*x6", "10*x6-1.5*x7", "2*x5-20*x8",
         "-5*x9**2*x7**4*(10*x6-1.5*x7)",
         "0.1*x14-3*x10+2.0*(x3+x8+x13+x18+x23)", "10*x10-2.2*x11", "10*x11-1.5*x12", "2*x10-20*x13",
         "-5*x14**2*x12**4*(10*x11-1.5*x12)",
         "0.1*x19-3*x15+2.0*(x3+x8+x13+x18+x23)", "10*x15-2.2*x16", "10*x16-1.5*x17", "2*x15-20*x18",
         "-5*x19**2*x17**4*(10*x16-1.5*x17)",
         "0.1*x24-3*x20+2.0*(x3+x8+x13+x18+x23)", "10*x20-2.2*x21", "10*x21-1.5*x22", "2*x20-20*x23",
         "-5*x24**2*x22**4*(10*x21-1.5*x22)"
         ],
...
def define_init_states(ha):
    ...
    rv.append(
        (ha.modes['1'], HyperBox([[-0.003, 0.197, 0.997, -0.003, 0.497, -0.001, 0.199, 0.999, -0.001, 0.499, 0.001,
                                   0.201, 1.001, 0.001, 0.501, 0.003, 0.203, 1.003, 0.003, 0.503, 0.005, 0.205, 1.005,
                                   0.005, 0.505],
                                  [-0.001, 0.199, 0.999, -0.001, 0.499, 0.001, 0.201, 1.001, 0.001, 0.501, 0.003,
                                   0.203, 1.003, 0.003, 0.503, 0.005, 0.205, 1.005, 0.005, 0.505, 0.007, 0.207, 1.007,
                                   0.007, 0.507]],
                                 opt=1)))
