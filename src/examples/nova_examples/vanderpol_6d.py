...
def define_ha():
    ...
    ha.variables = ["x0", "x1", "x2", "x3", "x4", "x5"]
    ...
    mode1.set_dynamics(["x1",
                       ...
                       is_linear=(True, False, True, False, True, False))
...
def define_settings():
    sys_dim = 6
    horizon = 7
    model_name = 'coupled_vanderpol_6d'
    ...
    verif_setting = VerificationSetting(a_matrix=np.array([0, -1, 0, 0, 0, 0]),
                                        b_col=np.array([-2.85]))
