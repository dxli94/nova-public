...
def define_ha():
    ...
    mode1 = ha.new_mode('1')
    mode1.set_dynamics(
        ["0.1*x4-3*x0+5.0*(x3+x8)", "10*x0-2.2*x1", "10*x1-1.5*x2", "2*x0-20*x3", "-5*x4**2*x2**4*(10*x1-1.5*x2)",
         "0.1*x9-3*x5+5.0*(x3+x8)", "10*x5-2.2*x6", "10*x6-1.5*x7", "2*x5-20*x8", "-5*x9**2*x7**4*(10*x6-1.5*x7)"],
...
def define_init_states(ha):
    ...
    # ARCH 19'
    rv.append((ha.modes['1'], HyperBox([[-0.003, 0.197, 0.997, -0.003, 0.497, -0.001, 0.199, 0.999, -0.001, 0.499],
                                        [-0.001, 0.199, 0.999, -0.001, 0.499, 0.001, 0.201, 1.001, 0.001, 0.501]],
                                       opt=1)))
